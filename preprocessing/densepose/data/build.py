...
from preprocessing.detectron2.data.build import (
...
from preprocessing.detectron2.data.catalog import (
    DatasetCatalog,
    Metadata,
    MetadataCatalog,
)
from preprocessing.detectron2.data.samplers import TrainingSampler
from preprocessing.detectron2.utils.comm import get_world_size

from preprocessing.densepose.config import get_bootstrap_dataset_config
from preprocessing.densepose.modeling import build_densepose_embedder
