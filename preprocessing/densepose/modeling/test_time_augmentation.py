...
from preprocessing.detectron2.data.transforms import (
    RandomRotation,
    RotationTransform,
    apply_transform_gens,
)
from preprocessing.detectron2.modeling.postprocessing import detector_postprocess
from preprocessing.detectron2.modeling.test_time_augmentation import (
    DatasetMapperTTA,
...
class DensePoseGeneralizedRCNNWithTTA(GeneralizedRCNNWithTTA):
    ...
    # the implementation follows closely the one from preprocessing.detectron2.modeling
