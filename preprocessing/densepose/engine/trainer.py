...
from preprocessing.detectron2.config import CfgNode
from preprocessing.detectron2.engine import DefaultTrainer
...
from preprocessing.detectron2.solver.build import (
    get_default_optimizer_params,
    maybe_add_gradient_clipping,
)
from preprocessing.detectron2.utils import comm
from preprocessing.detectron2.utils.events import EventWriter, get_event_storage

from preprocessing.densepose import (
    DensePoseDatasetMapperTTA,
    DensePoseGeneralizedRCNNWithTTA,
    load_from_cfg,
)
from preprocessing.densepose.data import (
    DatasetMapper,
...
from preprocessing.densepose.evaluation.d2_evaluator_adapter import (
    Detectron2COCOEvaluatorAdapter,
)
from preprocessing.densepose.evaluation.evaluator import (
    DensePoseCOCOEvaluator,
    build_densepose_evaluator_storage,
)
from preprocessing.densepose.modeling.cse import Embedder
