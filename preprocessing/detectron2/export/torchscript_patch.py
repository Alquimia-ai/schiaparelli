...
from preprocessing.detectron2.utils.env import _import_file
...
def patch_nonscriptable_classes():
    ...
    from preprocessing.detectron2.modeling.backbone import ResNet, FPN
    ...
    from preprocessing.detectron2.modeling.roi_heads import StandardROIHeads
